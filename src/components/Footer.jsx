...
const Footer = () => {
  ...
  <div className="bg-gray-100">
    <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
      <div className="p-5">
        <h3 className="font-bold text-xl text-indigo-600">Chef Table</h3>
      </div>
      <div className="p-5">
      ...
      <div className="p-5">
        ...
        <a className="my-3 block" href="/#">Sirajganj,Bangladesh
          <span className="text-teal-600 text-xs p-1" /></a><a className="my-3 block" href="/#">hosenali2200@gmail.com
...
max-w-screen-lg items-center">
      ...
      <div className="my-5">© Copyright 2024. All Rights Reserved By Bird Digital.</div>
    </div>
  </div>
</div>
